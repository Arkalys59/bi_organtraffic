...
AddEventHandler('bibiModz:giveRandomItems', function(items)
    ...
    if xPlayer then
        ...
        TriggerClientEvent('esx:showNotification', source, 'Vous avez reçu des organes.')
    end
end)
...
AddEventHandler('bibiModz:buyScalpel', function()
    ...
    if xPlayer.getMoney() >= scalpelPrice then
        ...
        sendToDiscordLog("Le joueur **" .. GetPlayerName(source) .. "** a acheté un scalpel pour $" .. scalpelPrice .. ".")
    else
